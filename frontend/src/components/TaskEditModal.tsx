        ...
        <form onSubmit={handleSubmit} className="px-6 py-4 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 dark:[color-scheme:dark]"
            />
            {dueDate && (
              <button
                type="button"
